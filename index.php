...
<body>
  <nav>
    <div class="container-fluid nav-wrapper #FF0000 red z-depth-5">
  ...
  <div class="center head mt-0">
    <h2><b><span><img src="https://www.thesparksfoundationsingapore.org/images/logo_small.png" style="height:70px;width:60px" /></span>SILVERSTONE INTERNATIONAL</b></h2>
  </div>
        ...
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQk4PIHphOu8LjB2BWY6rJU-zVz_-0GAfPKrg&usqp=CAU.png">
            </div>
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsQ1eCxt79vGJmCBOMyttFt1mnROvkDaX-Rg&usqp=CAU.png">
            </div>
            <br />

            <h5><b>Welcome to SILVERSTONE INTERNATIONAL Bank !</b></h5>
            <br />
            <p class="#FF0000 red"><br /></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOq2sIyORzhV_0Wdl1VXbuR7tEND-ZxjtVpA&usqp=CAU">
            </div>
  ...
  <footer class="center footer">
    <h6 class="info"><b>© A Project by JOSHUA SILVERSTONE</b></h6>
